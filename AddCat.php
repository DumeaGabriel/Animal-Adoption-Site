...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./CSS/addCat.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <form action="./php/addCatToDB.php" method="post" enctype="multipart/form-data"> 
                <div class="Nume">
                <label >Numele pisicii</label>
                        <input name="nume" type="text" placeholder="Numele Pisicii" class="form-control form-control-sm" required>
                        
                </div>
                    <label>Varsta pisicii?</label>
                ...
                <label>Este de rasa?</label>
                <select name="rasa" name="rasa" class="form-select form-select-lg mb-3" >
